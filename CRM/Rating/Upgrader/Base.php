 ...
 */
class CRM_Rating_Upgrader_Base {

  /**
   * @var CRM_Rating_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Rating_Upgrader(
        'de.animalsociety.rating',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Rating_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Rating_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
